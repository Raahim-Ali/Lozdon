...
const HeroSection = ({ title, paragraph, imgSrc }) => {
  return (
    ...
    >
      <div className="text-white px-4 sm:px-8 max-w-full flex flex-col gap-[30px] py-[150px] items-start text-left">
        <ul className="flex gap-8 list-disc items-start md:text-base sm:text-xs text-[1rem] justify-start">
          <li className="marker:font-normal list-none uppercase">Secure</li>
          <li className="marker:font-normal uppercase">Efficient</li>
          <li className="marker:font-normal uppercase">Professional</li>
        </ul>
        <h1
